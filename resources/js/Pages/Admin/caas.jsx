...
export default function Caas({ users, stages }) {
    console.log(users);
    ...
    return (
        <>
            ...
            <div className="fixed inset-0 w-full h-full bg-[#0a2a4a] text-white overflow-hidden font-sans">
                ...
                {/* MAIN CONTENT AREA */}
                <div
                    className={`absolute inset-0 z-10 flex flex-col items-center justify-center p-4 md:p-8 transition-all duration-1000 ${isZooming ? "opacity-0 scale-95" : "opacity-100 scale-100"}`}
                >
                                ...
                                <table className="w-full text-left border-collapse min-w-[950px]">
                                    ...
                                    <tbody className="font-sans">
                                        {users.data.map((item, index) => (
                                            ...
                                            >
                                                <td
                                                    className={`${viewMode === "small" ? "py-1.5" : "p-4"} pl-8 font-mono text-white/30 text-[10px]`}
                                                >
                                                    {(currentPage - 1) *
                                                        ITEMS_PER_PAGE +
                                                        index +
                                                ...
                                                <td
                                                    className={`${viewMode === "small" ? "py-1.5" : "p-4"}`}
                                                >
                                                ...
                                                <td
                                                    className={`${viewMode === "small" ? "py-1.5 text-[11px]" : "p-4 text-sm"} italic font-light text-cyan-100/70`}
                                                >
                                                    {item.profile?.major ||
                                                        "N/A"}
                                                </td>
                                                <td
                                                    className={`${viewMode === "small" ? "py-1.5 text-[11px]" : "p-4 text-sm"} font-semibold text-cyan-100`}
                                                >
                                                    {item.profile?.class ||
                                                        "N/A"}
                                                </td>
                                                ...
                                                >
                                                    <select
                                                        ...
                                                        className="bg-transparent border border-white/10 rounded-sm px-2 py-1 text-cyan-100 text-xs focus:outline-none focus:border-cyan-500/50 cursor-pointer hover:border-cyan-400/30 transition-all"
                                                    >
                                                        {stages.map((stage) => (
                                                            <option
                                                                key={stage.id}
                                                        ...
                                                        <div className="flex items-center gap-1.5">
                                                            {[
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={`
                                                                        ${viewMode === "small" ? "px-2 py-0.5 text-[8px]" : "px-3 py-1 text-[9px]"}
                                                ...
                                                <td
                                                    className={`${viewMode === "small" ? "py-1.5" : "p-4"} pr-8`}
                                                >
                                                    <div className="flex justify-center gap-3">
                                                        <button
                                                            ...
                                                            className="p-2 border border-cyan-500/30 text-cyan-400 hover:text-white rounded-sm hover:bg-cyan-500/10 transition-all"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-2 border border-rose-500/30 text-rose-400 hover:text-white rounded-sm hover:bg-rose-500/10 transition-all"
                                                        >
